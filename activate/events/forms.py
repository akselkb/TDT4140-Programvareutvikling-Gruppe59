...
class CreateActivityForm(forms.ModelForm):
    ...
    meeting_place = forms.CharField(label='Oppmøtested', max_length=200, help_text='Må være tydelig.')
    ...
    class Meta:
        model = Activity
        fields = ('title', 'text', 'date', 'time_from', 'time_to', 'max_participants', 'gear', 'price', 'meeting_place',
